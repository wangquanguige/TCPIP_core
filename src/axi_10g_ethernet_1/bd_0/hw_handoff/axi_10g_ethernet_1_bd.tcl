...
################################################################
# This is a generated script based on design: bd_2f1a
#
...
proc create_root_design { parentCell } {
  ...
  set core_to_gt_drp [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:drp_rtl:1.0 core_to_gt_drp ]
  set gt_drp [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:drp_rtl:1.0 gt_drp ]
  ...
  set drp_gnt [ create_bd_port -dir I drp_gnt ]
  set drp_req [ create_bd_port -dir O drp_req ]
  ...
  set_property -dict [ list \
   CONFIG.DClkRate {50.00} \
   CONFIG.IEEE_1588 {None} \
   CONFIG.Locations {X0Y15} \
  ...
  connect_bd_intf_net -intf_net gt_drp_1 [get_bd_intf_ports gt_drp] [get_bd_intf_pins xpcs/gt_drp]
  ...
  connect_bd_intf_net -intf_net xpcs_core_to_gt_drp [get_bd_intf_ports core_to_gt_drp] [get_bd_intf_pins xpcs/core_to_gt_drp]
  ...
  connect_bd_net -net drp_gnt_1 [get_bd_ports drp_gnt] [get_bd_pins xpcs/drp_gnt]
  ...
  connect_bd_net -net xpcs_drp_req [get_bd_ports drp_req] [get_bd_pins xpcs/drp_req]
