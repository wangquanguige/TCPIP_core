...
########################################################
#
## GTHE3_CHANNEL_X0Y15 was selected for use from the customization GUI.  This transcevier is located in the GT Quad GTHE3_COMMON_X0Y3
#
## The following reference clock source to the GTHE3_COMMON_X0Y3 is as selected from the IP customization GUI.
#set_property LOC GTHE3_COMMON_X0Y4 [get_cells -hier -filter {NAME=~  *shared_clocking_wrapper*ibufds_inst}]
#
#
